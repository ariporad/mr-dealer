...
describe('Game Reducer', () => {
	it('addUser', () => {
		...
		expect(getState().players).toEqual([
			{ name: 'Ari Porad', id: 0, folded: false, bets: [], hand: null },
		]);
		...
		expect(getState().players).toEqual([
			{ name: 'Ari Porad', id: 0, folded: false, bets: [], hand: null },
			{ name: 'Neb Scherzer', id: 1, folded: false, bets: [], hand: null },
			{ name: 'Sophie G-H', id: 2, folded: false, bets: [], hand: null },
			{ name: 'Beth Ginsberg', id: 3, folded: false, bets: [], hand: null },
		]);
	});
});
